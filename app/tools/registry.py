...
class ToolRegistry:
    def __init__(self, allowed_directory: Path) -> None:
        ...
        self._handlers: dict[str, Callable[..., dict[str, Any]]] = {
            "get_disk_space": lambda: get_disk_space(),
    ...
    def definitions(self) -> list[ToolDefinition]:
        ...
        return [
            ToolDefinition("get_disk_space", "Consulta espaço total, usado e livre do disco principal.", empty),
            ToolDefinition("get_memory_usage", "Consulta o uso atual da memória RAM.", empty),
            ToolDefinition("get_system_info", "Consulta sistema operacional, arquitetura, computador e Python.", empty),
            ToolDefinition("list_files", "Lista nomes, tipos e tamanhos em uma pasta autorizada, sem ler conteúdo.", {"type": "object", "properties": {"path": {"type": "string", "description": "Caminho relativo à pasta autorizada; use '.' para a raiz."}}, "additionalProperties": False}),
        ]
