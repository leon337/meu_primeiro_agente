...
def test_browser_dry_run_respects_allowlist_and_hides_values() -> None:
    executor = PlaywrightBrowserExecutor(("vercel.com",), dry_run=True)
...
def test_browser_blocks_domain_plain_http_and_unapproved_submit() -> None:
    executor = PlaywrightBrowserExecutor(("vercel.com",), dry_run=True)
